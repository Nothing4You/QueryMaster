...
namespace QueryMaster
{
    static class MasterUtil
    {
        ...
        internal static string ProcessFilter(IpFilter filter)
        {
            ...
            {
                case ServerType.Dedicated: filterStr.Append(@"\type\d"); break;
                case ServerType.Listen: filterStr.Append(@"\type\l"); break;
                case ServerType.SourceTV: filterStr.Append(@"\type\p"); break;
                default: break;
            }
            if (filter.IsSecure)
